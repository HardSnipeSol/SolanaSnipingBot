...
**Solana Raydium sniper bot** that listens to new Raydium SOL pools and buys tokens for a fixed amount in SOL/WSOL.
...
3. Convert some SOL to WSOL (you need SOL or WSOL depending on the configuration set below)
